...
class OwnerControllerTest {
    ...
    @BeforeEach
    void setUp() {
        returnOwner1 = new Owner();
        returnOwner1.setId(1L);
        returnOwner1.setAddress("Gd1");
...
//                .andExpect(model().attribute("owners", hasSize(2)));
    ...
    void processCreationForm() throws Exception {
        when(ownerService.save(ArgumentMatchers.any())).thenReturn(returnOwner1);
    ...
    void initUpdateOwnerForm() throws Exception {
        when(ownerService.findById(anyLong())).thenReturn(returnOwner1);
